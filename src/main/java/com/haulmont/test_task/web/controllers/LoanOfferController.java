...
import com.haulmont.test_task.service.*;
import com.haulmont.test_task.service.dto.*;
import com.haulmont.test_task.dao.entity.YearsOfCredit;
...
public class LoanOfferController {
    ...
    public String createNewLoanAgreement(@ModelAttribute("loan_processing") CalculatedDataAndId loanProcessing){
        if(loanOfferService.checkIfOfferAlreadyExist(loanProcessing)){
